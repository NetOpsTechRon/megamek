 ...
 * @since Sep 25, 2004
 */
public class ISXLaserAMS extends LaserWeapon {
    @Serial
    ...
    public ISXLaserAMS() {
        super();
        name = "Laser AMS (X)";
        setInternalName("ISLaserAntiMissileSystem (X)");
        addLookupName("IS Laser Anti-Missile (X))");
        addLookupName("IS Laser AMS (X)");
        addLookupName("ISXLaserAMS");
        heat = 1;
        rackSize = 2;
