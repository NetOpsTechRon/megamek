 ...
 * @since Sep 25, 2004
 */
public class CLXLaserAMS extends LaserWeapon {
    @Serial
    private static final long serialVersionUID = 3252387868757752971L;

    public CLXLaserAMS() {
        super();
        name = "Laser AMS (X)";
        setInternalName("CLLaserAntiMissileSystem (X)");
        addLookupName("Clan Laser Anti-Missile (X)");
        addLookupName("Clan Laser AMS (X)");
        heat = 1;
        rackSize = 2;
